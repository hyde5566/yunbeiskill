...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: '反馈内容不能为空' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateFeedbackDto.prototype, "content", void 0);
class MarkInvalidDto {
    is_invalid;
}
exports.MarkInvalidDto = MarkInvalidDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: '是否无效（0=正常，1=无效）' }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], MarkInvalidDto.prototype, "is_invalid", void 0);
