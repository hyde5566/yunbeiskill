...
export declare class SkillService {
    ...
    constructor(skillRepository: Repository<Skill>, skillVersionRepository: Repository<SkillVersion>, skillVisibilityRepository: Repository<SkillVisibility>, projectSkillRepository: Repository<ProjectSkill>, reviewRepository: Repository<Review>);
    ...
    update(id: number, updateDto: UpdateSkillDto, userId: number, isAdmin: boolean): Promise<Skill>;
    ...
    resubmit(id: number, submitterId: number): Promise<Skill>;
